        ...
        <div class="signin-signup">
          <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post" class="sign-in-form">
            ...
            <div class="input-field">
              ...
              <input type="email" placeholder="Email" name="Useremail_" />
            </div>
            <div class="input-field">
              <i class="fas fa-lock"></i>
              <input type="password" placeholder="Password" name="Userpassword_" />
            </div>
          ...
          <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post" class="sign-up-form">
            ...
            <input type="submit" class="btn" value="Sign up" name="reg_submit"/>
